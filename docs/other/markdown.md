...
考虑到很多项目在开发时，时常遇到网络限制情况，导致网站无法访问，所以配置了一个本地访问的入口，大家根据项目实际情况及时更新[官方文档](https://github.com/you-hei-mi/vue-project-docs/edit/main/docs/zh/guide/markdown.md)。
:::
...
- [VitePress on GitHub](https://github.com/you-hei-mi/vue-project-docs)
...
还可以全局配置中自定义语法高亮主题。有关详细信息，参见 [`markdown` 选项](https://vitepress.dev/zh/reference/site-config#markdown#markdown)得到更多信息。
...
查看 [`markdown` 选项](https://vitepress.dev/zh/reference/site-config#markdown#markdown) 获取更多信息。
